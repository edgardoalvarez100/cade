    ...
    <body>
        ...
        <div class="contentarea" id="contentarea">
            <div style="float:left;width:100%;">
                ...
                <form method="post" action="grabarticket.php" >

                    <table class="form" width="100%" border="0" cellspacing="2" cellpadding="3">
                        <tr>
                            <td width="15%" class="fieldlabel">Categoria</td>
                            <td class="fieldarea">
                                <select name="categoria">
                                    <?php
                                    $sql = "select * from categorias";
                                    $categoria = mysql_query($sql, $conectar);
                        ...
                        <tr><td class="fieldlabel">Asunto</td><td class="fieldarea"><input type="text" name="asunto" size="75" value="" required ></td></tr>
                    </table>
                    <img src="images/spacer.gif" height="8" width="1"><br>
                    <textarea name="mensaje" id="replymessage" rows=20 style="width:100%" required>
                    ...
                    <img src="images/spacer.gif" height="8" width="1"><br>
                    <div align="center"><input type="submit" value="Crear Ticket" class="button"></div>
                </form>
            </div>
            <div class="clear"></div>
        </div>

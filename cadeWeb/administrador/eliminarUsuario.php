    ...
    <body>
        ...
        <div class="contentarea" id="contentarea">
            <div style="float:left;width:100%;">
                 ...
                 if($_GET["action"] == "save"){
                    echo "<div class='infobox'>Cuenta Eliminada Correctamente!</div>";
                 }}
                   ?>
                <?php
                //consulta para buscar datos del empleado 
                $sql = "SELECT * from usuarios u inner join tipousuario tu ON u.idtipo=tu.idtipo WHERE cedula=" . $cedula;
                $reporte = mysql_query($sql, $conectar);
                while ($rep = mysql_fetch_array($reporte)) {
                    ?>
                    <h1>Mi cuenta</h1>
                    <form method="post" action="eliminarUsuarioRT.php">
                        ...
                        <table class="form" width="100%" border="0" cellspacing="2" cellpadding="3">
                            ...
                            <tr>
                                <td width="20%" class="fieldlabel">Rol</td><td class="fieldarea"><b><?php echo $rep["tipousuario"]; ?></b></td></tr>
                            <tr>
                                <td width="20%" class="fieldlabel">Nombre</td><td class="fieldarea"><b><?php echo $rep["nombre"]; ?></b></td></tr>
                            <tr>
                                <td width="20%" class="fieldlabel">Apellidos</td><td class="fieldarea"><b><?php echo $rep["apellidos"]; ?></b></td></tr>
                            <tr>
                                <td width="20%" class="fieldlabel">Correo Electronico</td><td class="fieldarea"><b><?php echo $rep["correo"]; ?></b></td></tr>
                            <tr>
                                <td width="20%" class="fieldlabel">Telefono</td><td class="fieldarea"><b><?php echo $rep["telefono"]; ?></b></td></tr>
                            <tr>
                                <td width="20%" class="fieldlabel">Direccion</td><td class="fieldarea"><b><?php echo $rep["direccion"]; ?></b></td></tr>
                            <tr>
                                <td width="20%" class="fieldlabel">Ciudad</td><td class="fieldarea"><b><?php echo $rep["ciudad"]; ?></b></td></tr>
                            
                        <?php }
                        ?> 
                    </table>

                    <p align="center"><input type="submit" value="Eliminar" class="button"></p>

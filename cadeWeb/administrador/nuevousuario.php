...
<?php include ("menu.php") ?>
        ...
        <div class="contentarea" id="contentarea">
            <div style="float:left;width:100%;">
                ...
                <form method="post" action="insertarUsuario.php" onsubmit="return validar(this);">

                    <table class="form" width="100%" border="0" cellspacing="2" cellpadding="3">
                        <tr>
                            <td width="20%" class="fieldlabel">Cedula</td><td class="fieldarea"><input type="text" name="cedula" size="30" required></td></tr>
                        <tr>
                            <td class="fieldlabel">Rol</td><td class="fieldarea"><select name="tipo"> 
                                    <?php
                                    $sql = "SELECT * FROM tipousuario";
                                    $consulta = mysql_query($sql, $conectar);
                                    echo mysql_error();
                                    while ($registro = mysql_fetch_array($consulta)) {
                                        echo '<option value="' . $registro["idtipo"] . '">' . $registro["tipousuario"] . '</option>';
                                    }
                                    ?>
                                </select></td></tr>
                        <tr><td class="fieldlabel">Nombre</td><td class="fieldarea"><input type="text" name="nombre" size="30" required></td></tr>
                        <tr><td class="fieldlabel">Apellidos</td><td class="fieldarea"><input type="text" name="apellidos" size="30" required></td></tr>
                        <tr><td class="fieldlabel">Correo electrónico</td><td class="fieldarea"><input type="email" name="correo" size="50" required></td></tr>


                        <tr>
                            <td class="fieldlabel">Telefono</td><td class="fieldarea"><input type="text" name="telefono" size="30" required></td></tr>
                        <tr>
                            <td class="fieldlabel">Dirección</td><td class="fieldarea"><input type="text" name="direccion" size="30" required></td></tr>
                        <tr>
                            <td class="fieldlabel">Ciudad</td><td class="fieldarea"><input type="text" name="ciudad" size="30" required></td></tr>
                    ...
                    <table class="form" width="100%" border="0" cellspacing="2" cellpadding="3">
                        <tr><td width="20%" class="fieldlabel">Contraseña</td><td class="fieldarea"><input type="password" name="pass1" size="25" required></td></tr>
                        <tr><td class="fieldlabel" >Confirmar contraseña</td><td class="fieldarea"><input type="password" name="pass2" size="25" required></td></tr>
                    </table>

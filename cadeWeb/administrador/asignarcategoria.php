        ...
        <div class="contentarea" id="contentarea">
            <div style="float:left;width:100%;">
                ...
                if (isset($_GET["action"])) {
                    if ($_GET["action"] == "1") {
                        echo "<div class='infobox'>Usuario no es un empleado!</div>";
                    }
                }
                ?>
                <h1>Ingrese Cedula</h1>
                <form method="post" action="asignarcategoria2.php" onsubmit="return validar(this);">

                    <table class="form" width="100%" border="0" cellspacing="2" cellpadding="3">
                        <tr>
                            <td width="20%" class="fieldlabel">Cedula</td><td class="fieldarea"><input type="text" class="cedula" name="cedula" size="30"></td></tr>

                    </table>


                    <p align="center"><input type="submit" value="Seleccionar" class="button"></p>

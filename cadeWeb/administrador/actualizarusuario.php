        ...
        <div class="contentarea" id="contentarea">
            <div style="float:left;width:100%;">
                ...
                while ($rep = mysql_fetch_array($reporte)) {
                    ?>
                    <h1>Mi cuenta</h1>
                    <form method="post" action="actualizarusuarioRT.php" onsubmit="return validar(this);">
                        ...
                        <table class="form" width="100%" border="0" cellspacing="2" cellpadding="3">
                            ...
                            <tr>
                                <td class="fieldlabel">Rol</td><td class="fieldarea">
                                    <select name="tipo"> 
                                    <?php
                                    $sql1 = "SELECT * FROM tipousuario";
                                    $consulta = mysql_query($sql1, $conectar);
                                    echo mysql_error();

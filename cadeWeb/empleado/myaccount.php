                ...
                while ($rep = mysql_fetch_array($reporte)) {
                    ...
                    <form method="post" action="guardarcuenta.php" onsubmit="return validar(this);">
                        ...
                        <table class="form" width="100%" border="0" cellspacing="2" cellpadding="3">
                            ...
                            <tr>
                                <td class="fieldlabel">Rol</td><td class="fieldarea"><strong>Empleado</strong></td></tr>
                            <tr><td class="fieldlabel">Nombre</td><td class="fieldarea"><input type="text" name="nombre" size="30" value="<?php echo $rep["nombre"]; ?>" required ></td></tr>
                            <tr><td class="fieldlabel">Apellidos</td><td class="fieldarea"><input type="text" name="apellidos" size="30" value="<?php echo $rep["apellidos"]; ?>" required ></td></tr>
                            <tr><td class="fieldlabel">Correo electrónico</td><td class="fieldarea"><input type="email" name="correo" size="50" value="<?php echo $rep["correo"]; ?>" required ></td></tr>


                            <tr>
                                <td class="fieldlabel">Telefono</td><td class="fieldarea"><input type="text" name="telefono" size="30" value="<?php echo $rep["telefono"]; ?>" required ></td></tr>
                            <tr>
                                <td class="fieldlabel">Dirección</td><td class="fieldarea"><input type="text" name="direccion" size="30" value="<?php echo $rep["direccion"]; ?>" required ></td></tr>
                            <tr>
                                <td class="fieldlabel">Ciudad</td><td class="fieldarea"><input type="text" name="ciudad" size="30" value="<?php echo $rep["ciudad"]; ?>" required ></td></tr>
                        <?php }
                        ?> <tr>
                            <td class="fieldlabel">Categorias</td><td class="fieldarea">
                                <?php
                                $checkear = "";
                                $sqlcategorias = "SELECT * FROM categorias";
                                $reporte = mysql_query($sqlcategorias, $conectar);
                                ...
                                while ($rep = mysql_fetch_array($reporte)) {
                                    ...
                                    echo ' <label>
                                                    <input type="checkbox" name="ticketnotify[]" value="' . $rep["idcategoria"] . '" 
                                                        ' . $checkear . ' Disabled /> ' . $rep["categoria"] . '
                                           </label><br />';
                                }
                                ?>
                    ...
                    <table class="form" width="100%" border="0" cellspacing="2" cellpadding="3">
                        <tr><td width="20%" class="fieldlabel">Contraseña</td><td class="fieldarea"><input type="password" name="pass" size="25"></td></tr>

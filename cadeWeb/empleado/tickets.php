...
WHERE e.estado <> 'CERRADO' and c.idcategoria IN (select c.idcategoria from usuarios u inner JOIN categoriasempleados ce ON u.idusuario=ce.idusuario 
    ...
    <body>
        ...
        <div class="contentarea" id="contentarea">
            <div style="float:left;width:100%;">
                <h1>Tickets <?php echo $estado; ?></h1>
                
                
                <div class="homecolumn ui-sortable" id="home">
                ...
                <div class="homecolumn ui-sortable" id="homecol1"></div>
                <div class="homecolumn ui-sortable" id="homecol2"></div>
